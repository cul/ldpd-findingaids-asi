...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: 'https://findingaids-test.library.columbia.edu'}

  #set default host for sitemap generator
  config.default_host = "https://findingaids-test.library.columbia.edu"
end
