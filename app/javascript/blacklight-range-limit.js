...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (inputSelector) inputSelector.classList.remove('sr-only');

  // Hide .more_facets
  const facetSelector = document.querySelector('.blacklight-date_range .more_facets');
  if (facetSelector) facetSelector.classList.add('visually-hidden');
});
