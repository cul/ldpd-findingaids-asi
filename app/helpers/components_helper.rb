module ComponentsHelper
  def checkbox_display(component_title, component_id, checkbox_id, container_info_string, container_info_barcode)
    checkbox_html_out = ''
...
#        container_info_string != @last_container_info_string_seen)
      ...
      checkbox_html_out =
        ...
        %Q(<label class="aeon_checkbox_label" for="#{checkbox_name}">Request #{container_info_string}</label>) <<
        '<br style="clear:both;">'
    end
    checkbox_html_out
  end
