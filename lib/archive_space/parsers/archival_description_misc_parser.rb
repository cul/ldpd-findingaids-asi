  ...
  module Parsers
    class ArchivalDescriptionMiscParser
      ...
      def parse(nokogiri_xml_document)
        ...
        @access_restrictions_values = ::Ead::Elements::Archdesc.accessrestrict_p_array(arch_desc)
        ...
        @accruals_values = ::Ead::Elements::Archdesc.accruals_p_array(arch_desc)
        ...
        @alternative_form_available_values = ::Ead::Elements::Archdesc.altformavail_p_array(arch_desc)
        ...
        @arrangement_values = ::Ead::Elements::Archdesc.arrangement_p_array(arch_desc)
        ...
        @biography_history_values = ::Ead::Elements::Archdesc.bioghist_p_array(arch_desc)
        ...
        @conditions_governing_use_values = ::Ead::Elements::Archdesc.userestrict_p_array(arch_desc)
        ...
        @other_descriptive_data_values = ::Ead::Elements::Archdesc.odd_p_array(arch_desc)
        ...
        @other_finding_aid_values = ::Ead::Elements::Archdesc.otherfindaid_p_array(arch_desc)
        ...
        @preferred_citation_values = ::Ead::Elements::Archdesc.prefercite_p_array(arch_desc)
        ...
        @processing_information_values = ::Ead::Elements::Archdesc.processinfo_p_array(arch_desc)
        ...
        @related_material_values = ::Ead::Elements::Archdesc.relatedmaterial_p_array(arch_desc)
        ...
        @scope_and_content_values = ::Ead::Elements::Archdesc.scopecontent_p_array(arch_desc)
        ...
        @separated_material_values = ::Ead::Elements::Archdesc.separatedmaterial_p_array(arch_desc)
      end
